...
<div style="text-align: center; color: #666; padding: 1rem; font-size: 0.9rem;">
    <p><strong>TEARFILM ANALYZER</strong> | TFOS DEWS III Based Diagnostic System</p>
    <p>© 2025 Toni Mandusic. All rights reserved.</p>
    <p><em>For professional use only. This software is provided for educational and clinical decision support purposes.</em></p>
