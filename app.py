...
def generate_client_report(tear_film_result, staining_result, clinical_params, diagnosis, severity):
    ...
    - Tear Film Grade: {tear_film_result.get('grade', 'N/A') if tear_film_result else 'N/A'}
    - Pattern Coverage: {tear_film_result.get('coverage', 'N/A'):.1f}% if tear_film_result else 'N/A'
    - Fluorescein Staining: {staining_result.get('staining_grade', 'N/A') if staining_result else 'N/A'}
    - Staining Area: {staining_result.get('staining_percentage', 'N/A'):.1f}% if staining_result else 'N/A'
