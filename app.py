...
def main():
    ...
    lipcof_temporal = st.slider("**LIPCOF Temporal**", 0, 3, 0,
                              help="Lid Parallel Conjunctival Folds - Temporal: 0=None, 1=Mild, 2=Moderate, 3=Sever
...
# CLIENT REPORT GENERATION - DODAJTE OVO
st.markdown("### 📄 Client Report")
if st.button("🖨️ Generate Client Report", type="secondary", use_container_width=True):
